...
module.exports = Object.assign({
	...
	Endpoints: {
		...
		ROUTES: {
			CHANNEL:            (guildId, channelId) => `/channels/${guildId || '@me'}/${channelId}`,
			GUILD:                         (guildId) => `/channels/${guildId || '@me'}`,
			MESSAGE: (guildId, channelId, messageId) => `/channels/${guildId || '@me'}/${channelId}/${messageId}`,
