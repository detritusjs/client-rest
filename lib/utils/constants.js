	...
	Endpoints: {
		...
		REST: {
			...
			USERS: {
				...
				ACTIVITY_JOIN:                 `/users/:userId:/sessions/:sessionId:/activity/${Constants.Discord.ActivityFlags.JOIN}`,
				ACTIVITY_JOIN_INVITE:          `/users/:userId:/sessions/:sessionId:/activity/${Constants.Discord.ActivityFlags.JOIN_REQUEST}/:invite:`, //is it invite? invite code? idk
				ACTIVITY_JOIN_REQUEST:         `/users/:userId:/sessions/:sessionId:/activity/${Constants.Discord.ActivityFlags.JOIN_REQUEST}`,
				ACTIVITY_METADATA:             '/users/:userId:/sessions/:sessionId:/activity/metadata',
				ACTIVITY_SPECTATE:             `/users/:userId:/sessions/:sessionId:/activity/${Constants.Discord.ActivityFlags.SPECTATE}`,
