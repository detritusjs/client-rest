...
export declare enum DiscordAbortCodes {
...
export declare enum DiscordHeaders {
...
export declare enum RatelimitPrecisionTypes {
...
export declare const RATELIMIT_BUCKET_MAJOR_PARAMS: readonly string[];
export declare const SPOILER_ATTACHMENT_PREFIX = "SPOILER_";
export declare const MESSAGE_DELETE_RATELIMIT_CHECK: number;
export declare const MESSAGE_DELETE_RATELIMIT_CHECK_OLDER: number;
