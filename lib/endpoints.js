...
class Endpoints
{
	...
	acceptInvite(code)
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({code}, {code: {type: 'string', required: true}});
			this.rest.request({
				route: {method: 'post', path: RestEndopints.INVITE, params}
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId, userId}, {
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId, userId, roleId}, {
				guildId: {type: 'snowflake', required: true},
				userId: {type: 'snowflake', required: true},
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, messageId}, {
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, userId}, {
				channelId: {type: 'snowflake', required: true},
				userId: {type: 'snowflake', required: true}
			});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId}, {guildId: {type: 'snowflake', required: true}});

			query = this.initData(query, {'days': {type: 'integer'}});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, messageIds}, {
				channelId: {type: 'snowflake', required: true},
	...
	createDm(recipient_id)
	{
		return new Promise((resolve, reject) => {
			this.rest.request({
				...
				body: this.initData({recipient_id}, {recipient_id: {type: 'snowflake', required: true}})
			}).then(resolve).catch(reject);
		});
	}
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId}, {channelId: {type: 'snowflake', required: true}});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, messageId, emoji}, {
				channelId: {type: 'snowflake', required: true},
				messageId: {type: 'snowflake', required: true},
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, overwriteId}, {
				channelId: {type: 'snowflake', required: true},
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId, emojiId}, {
				guildId: {type: 'snowflake', required: true},
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId, integrationId}, {
				guildId: {type: 'snowflake', required: true},
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({channelId, messageId, emoji, userId}, {
				channelId: {type: 'snowflake', required: true},
				messageId: {type: 'snowflake', required: true},
				emoji: {type: 'string', required: true},
				userId: {type: 'snowflake', required: true}
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({userId}, {userId: {type: 'snowflake', required: true}});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({guildId, roleId}, {
				guildId: {type: 'snowflake', required: true},
				roleId: {type: 'snowflake', required: true}
			});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({webhookId}, {webhookId: {type: 'snowflake', required: true}});
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({webhookId, token}, {
	...
	editChannelPositions(guildId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = body.map((channel) => this.initData(channel, {id: {type: 'snowflake', required: true}, position: {type: 'integer', required: true}}));
	...
	editGuildVanityUrl(guildId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = this.initData(body, {code: {type: 'string'}});
	...
	editNick(guildId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = this.initData(body, {nick: {type: 'string'}});
	...
	editNote(userId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = this.initData(body, {note: {type: 'string'}});
	...
	editRelationship(userId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = this.initData(body, {type: {type: 'integer'}});
	...
	editRolePositions(guildId, body)
	{
		return new Promise((resolve, reject) => {
			...
			body = body.map((role) => this.initData(role, {id: {type: 'snowflake', required: true}, position: {type: 'integer', required: true}}));
	...
	editVanityUrl(guildId, data)
	{
		return new Promise((resolve, reject) => {
			...
			this.rest.request({
				route: {method: 'patch', path: RestEndpoints.GUILDS.VANITY_URL, params},
				body: this.initData(data, {code: {type: 'string', required: true}})
			}).then(resolve).catch(reject);
		});
	}
	...
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({providerId}, {providerId: {type: 'string', required: true}});
	...
	fetchGames()
	{
		return this.rest.request({route: {method: 'get', path: RestEndpoints.GAMES.ALL}});
	}

	fetchGame(gameId)
	{
		return new Promise((resolve, reject) => {
			const params = this.initData({gameId}, {gameId: {type: 'snowflake', required: true}});
			this.rest.request({
	...
	fetchGameNews(gameId)
	{
		return new Promise((resolve, reject) => {
			...
			const params = this.initData({gameId}, {gameId: {type: 'array', required: true}});
			this.rest.request({
	...
	fetchGatewayBot()
	{
		return this.rest.request({route: {method: 'get', path: RestEndpoints.GATEWAY_BOT}});
	}
	...
	fetchInvite(code, query)
	{
		return new Promise((resolve, reject) => {
			...
			query = this.initData(query, {with_counts: {type: 'bool'}});
	...
	fetchVoiceRegions(guildId)
	{
		return new Promise((resolve, reject) => {
			...
			if (guildId) {
				route.params = this.initData({guildId}, {guildId: {type: 'snowflake', required: true}});
	...
	{
		return new Promise((resolve, reject) => {
			const body = this.initData({token, reports}, {
				token: {type: 'string'},
	...
	searchChannel(channelId, query)
	{
		return new Promise((resolve, reject) => {
			...
			this.rest.request({
				...
				if (response.status !== 202 || response.data.code !== 110000) {return resolve(response);}
				setTimeout(() => {
	...
	{
		return new Promise((resolve, reject) => {
			const body = this.initData({email}, {email: {type: 'string', required: true}});
			this.rest.request({
	...
	{
		return new Promise((resolve, reject) => {
			const body = this.initData({number}, {number: {type: 'string', required: true}});
			this.rest.request({
